...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Evalseer - Home Page</title>  
	...
	<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<div id="home" class="first-section" style="background-image:url('images/banner_img.png');">
					<div class="dtab">
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Evalseer </strong> Auto Assessment</h2>
										<p class="lead">Programmers Best Friend </p>
            ...
            <div class="blog-card spring-fever" style="position: relative;">
                ...
                <div class="utility-info">
                  <ul class="utility-list">
                    <li><span class="licon icon-like"></span><a href="#">Courses: 2</a></li>
                    <li><span class="licon icon-com"></span><a href="#">Year: 1</a></li>
                    <li><span class="licon icon-dat"></span>Badges: 5</li>
                    <li><span class="licon icon-tag"></span>Some Text</li>
                  </ul>
                </div>
              ...
              <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3 style="margin-top: 45px;">Current Placement</h3>
                </div>
              </div><!-- end title -->
              ...
              <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3 style="margin-top: 45px;">Recent Achievements</h3>
                </div>
              </div><!-- end title -->
              ...
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col" style="text-align: center;"><img src="images/test.png" width="150" height="150"></img></th>
                    <th scope="col" style="text-align: center;"><img src="images/test.png" width="150" height="150"></img></th>
                    <th scope="col" style="text-align: center;"><img src="images/test.png" width="150" height="150"></img></th>
                    <th scope="col" style="text-align: center;"><img src="images/test.png" width="150" height="150"></img></th>
                  </tr>
