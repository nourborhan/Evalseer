           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="Leaderboard.php"><i class="fa fa-table fa-3x"></i> Leaderboards</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Advanced Tables -->
                    <div class="panel panel-default" style="display: none;" id="Leaderboard">
                        <div class="panel-heading">
                             All taken courses leaderboard
                        </div>
