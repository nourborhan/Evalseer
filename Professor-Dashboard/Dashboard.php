                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div class="panel panel-back noti-box">
                            ...
                            <div class="text-box">
                                ...
                                <p class="text-muted">Assignments Uploaded</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="panel panel-back noti-box">
                            ...
                            <div class="text-box">
                                <p class="main-text">52 Students at risk</p>
                                <p class="text-muted">Please check their profiles</p>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Assignment Submissions</div>
                            <div class="panel-body">
                    ...
                    <!-- <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-green">
                            ...
                            <div class="panel-footer back-footer-green">
                                ...
                                Lorem ipsum dolor sit amet sit sit, consectetur adipiscing
                                elitsit sit gthn ipsum dolor sit amet ipsum dolor sit amet
                            </div>
                        </div>
                    </div> -->
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Course Leaderboard</div>
                            <div class="panel-body">
